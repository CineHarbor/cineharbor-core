...
use cineharbor_profile::{LocalProfileSnapshot, ProfileDomain};
use cineharbor_sync::{
...
struct RemoteMergedProfileSnapshot {
    play_records: cineharbor_profile::PlayRecordMap,
    favorites: cineharbor_profile::FavoriteMap,
    follows: cineharbor_profile::FollowRecordMap,
    search_history: Vec<String>,
    skip_configs: cineharbor_profile::SkipConfigMap,
}
